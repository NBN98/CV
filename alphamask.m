%%How to use the function to create two colord overlays with transparency after computing the logical mask
%%"foreground" for one frame.
% 
%     other=~foreground; %mask for background is the opposite
%     hOVM = alphamask(foreground); %overlay for foreground, default is blue and 50% transparency
%     second_hOVM=alphamask(other,[1 0 0],0.3); %overlay for background, this example is red and 30% transparency
